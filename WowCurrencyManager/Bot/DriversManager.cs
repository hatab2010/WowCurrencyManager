...
{
    public class DriversManager : ManagerBase
    {
        ...
        {
            var prevBalanceOperation = _opertions
                .FirstOrDefault(_ => _.Sender == room && _ is EditOrderOperaion);
        ...
        public static DriversManager Init()
        {      
            if (_instance == null)
            {
                return new DriversManager();
            }
            else
            {
                return _instance;
